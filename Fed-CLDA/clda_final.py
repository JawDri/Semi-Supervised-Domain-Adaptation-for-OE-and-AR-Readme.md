...
def train():
    ...
    for step in range(start_step, all_step):
        ...
        #im_data_tu2 = im_data_tu2.view(-1,1, 1)
        zero_grad_all()
        #print(im_data_s.shape, im_data_t.shape, im_data_tu.shape, im_data_tu2.shape)
        ...
        if (step % args.save_interval == 0 or step+1== args.steps) and step > 0:
            loss_test, acc_test, fscore = test(target_loader_test)
            ...
            print('best fscore test %f' % (best_fscore_test))
